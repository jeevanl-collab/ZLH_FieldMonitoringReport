		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Filed Monitoring Report",
									"targetURL": "#comsaplhcszlhfieldmonitoring-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comsaplhcszlhfieldmonitoring-display": {
								"semanticObject": "comsaplhcszlhfieldmonitoring",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.sap.lh.cs.zlhfieldmonitoring",
									"url": sap.ui.require.toUrl("com/sap/lh/cs/zlhfieldmonitoring")
								}
							}
						}
					}
